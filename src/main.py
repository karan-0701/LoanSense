...
RAW_CSV = "../data/raw/loan_dataset.csv"
PROCESSED_CSV = "../data/processed/processed_sample.csv"
DL_MODEL_PATH = "../models/deep_learning/dl_model.pth"
RL_MODEL_PATH = "../models/reinforcement_learning/rl_model.pth"
